...
object ShareHelper {
    fun shareShopList(nameQuiz: String, id: List<CrimeNewQuiz>, nameAnswerQuestion: Boolean): Intent {
    ...
    private fun makeShareText(nameQuiz: String, id: List<CrimeNewQuiz>, nameAnswerQuestion: Boolean): String {
